...
class GaloisField implements Comparable<GaloisField> {
    ...
    public GaloisField add(final GaloisField other) {
        this.value += other.value;
        this.value %= GaloisField.P;
    ...
    public GaloisField add(final long other) {
        this.value += other;
        this.value %= GaloisField.P;
    ...
    public GaloisField subtract(final GaloisField other) {
    ...
    public GaloisField subtract(final long other) {
    ...
    public GaloisField multiply(final GaloisField other) {
        this.value *= other.value;
        this.value %= GaloisField.P;
    ...
    public GaloisField multiply(final long other) {
        this.value *= other;
    ...
    public GaloisField divide(final GaloisField other) throws ArithmeticException {
        if (other.value == 0) {
    ...
    public GaloisField divide(final long other) throws ArithmeticException {
        if (other == 0) {
            throw new ArithmeticException(String.format("Division not defined for uninvertible elements"));
        }
