mod recursive_algebra;

use recursive_algebra::factorial;
use recursive_algebra::gcd;
use recursive_algebra::solve_diophantine;
use recursive_algebra::DiophantineSolution;
use recursive_algebra::DiophantineSolutionType;
